...
cp config_franka_robot.yml /workspace/src/install/franka_follower_controllers/share/franka_follower_controllers/config/config_franka_robot.yaml

# For debugging
# sleep infinity

ros2 launch franka_follower_controllers follower.launch.py config_file:=/workspace/src/install/franka_follower_controllers/share/franka_follower_controllers/config/config_franka_robot.yaml
